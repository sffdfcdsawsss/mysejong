...
function mouseleave2() {
    changeBtn2.setAttribute("src", "../imgs/location/location_map_color.png");
}
...
function kakaoMap() {
    ...
    const mapContainer = document.getElementById('map'), // 지도를 표시할 div 
        mapOption = {
            center: new kakao.maps.LatLng(37.572532, 126.975644), // 지도의 중심좌표
            level: 2, // 지도의 확대 레벨.
    ...
    // 마커 이미지의 주소
    const markerImageUrl = 'https://i.postimg.cc/KYhJkz1b/location-map-color.png',
    ...
    const marker = new kakao.maps.Marker({
        position: new kakao.maps.LatLng(37.572532, 126.975644), // 마커의 좌표
